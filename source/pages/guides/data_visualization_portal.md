...
```{image} ../../_static/images/data-visualization-portal-metadata-dashboard.png
...
```{image} ../../_static/images/data-visualization-portal-processed-data-filter.png
...
```{image} ../../_static/images/data-visualization-portal-studies-by-factor.png
...
```{image} ../../_static/images/data-visualization-portal-studies-by-factor-plot.png
...
```{image} ../../_static/images/data-visualization-portal-studies-by-factor-level.png
...
```{image} ../../_static/images/data-visualization-portal-results-factors.png
...
```{image} ../../_static/images/data-visualization-portal-studies-tables.png
:alt: Studies table
:width: 800px
```
...
```{image} ../../_static/images/data-visualization-portal-studies-tables-sort.png
...
```{image} ../../_static/images/data-visualization-portal-single-study.png
...
```{image} ../../_static/images/data-visualization-portal-single-study-sidebar.png
...
```{image} ../../_static/images/data-visualization-portal-single-study-details.png
...
```{image} ../../_static/images/data-visualization-portal-single-study-sample-info.png
...
```{image} ../../_static/images/data-visualization-portal-single-study-sidebar-labels.png
...
```{image} ../../_static/images/data-visualization-portal-single-study-sidebar-group-selection.png
...
```{image} ../../_static/images/data-visualization-portal-single-study-modify-groups.png
...
```{image} ../../_static/images/data-visualization-portal-single-study-group-selection.png
...
```{image} ../../_static/images/data-visualization-portal-single-study-update-groups.png
...
DGE represents the number of sequence reads that originated from a particular gene. The higher the number of counts, the more reads associated with that gene, and the assumption that there was a higher level of expression of that gene in the sample.
...
```{image} ../../_static/images/data-visualization-portal-plotly-example.png
:alt: Plotly options
:width: 800px
```

The house icon within the options will reset the axes of the plots back to default. Users are also provided the option to zoom in/out on each plot as well as auto-scale the graphic. There are two tools provided for data point selection, which are the lasso tool and box tool. Each of these tools provides a shape that will select any data points that fall within them. Lastly, there is a download button in the shape of a camera that will let you download the plot as a PNG file.

```{image} ../../_static/images/data-visualization-portal-plotly-toolbar.png
...
```{image} ../../_static/images/data-visualization-portal-pca-plot.png
...
```{image} ../../_static/images/data-visualization-portal-2d-pca-plot.png
:alt: 2D PCA plot
:width: 800px
```
...
```{image} ../../_static/images/data-visualization-portal-pca-plot-color.png
...
```{image} ../../_static/images/data-visualization-portal-pca-plot-eigenvector.png
...
The labels provided represent the factor values corresponding to each sample. Click on the label "Space Flight & Wild Type" and the data points will be hidden as shown below:

```{image} ../../_static/images/data-visualization-portal-pca-plot-labels.png
...
```{image} ../../_static/images/data-visualization-portal-pair-plot.png
...
```{image} ../../_static/images/data-visualization-portal-pair-plot-threshold.png
...
```{image} ../../_static/images/data-visualization-portal-pair-plot-displayed-samples.png
...
```{image} ../../_static/images/data-visualization-portal-pair-plot-update-correlations.png
...
```{image} ../../_static/images/data-visualization-portal-volcano-plot.png
...
```{image} ../../_static/images/data-visualization-portal-volcano-plot-thresholds.png
...
```{image} ../../_static/images/data-visualization-portal-volcano-plot-displayed-data.png
...
```{image} ../../_static/images/data-visualization-portal-heatmap.png
...
```{image} ../../_static/images/data-visualization-portal-heatmap-clustering-method.png
...
```{image} ../../_static/images/data-visualization-portal-heatmap-toggle-data.png
...
```{image} ../../_static/images/data-visualization-portal-dge-table.png
...
```{image} ../../_static/images/data-visualization-portal-dge-table-thresholds.png
...
```{image} ../../_static/images/data-visualization-portal-gsea.png
:alt: GSEA overview
:width: 800px
```
...
```{image} ../../_static/images/data-visualization-portal-gsea-update-gene-set.png
...
3. Gene Number Range: Adjust the minimum and maximum gene sizes. The minimum threshold omits genes with fewer than the specified number of data points, and the maximum threshold omits genes with more than the specified number of data points. The default values for min and max size thresholds are 15 and 500, respectively.
...
```{image} ../../_static/images/data-visualization-portal-gsea-nes-table.png
:alt: NES Table
:width: 800px
```
...
```{image} ../../_static/images/data-visualization-portal-gsea-nes-plot.png
:alt: NES Plot
:width: 800px
```
...
```{image} ../../_static/images/data-visualization-portal-gsea-dot-plot.png
:alt: Dot Plot
:width: 800px
```

- **Ridge Plot:**
  - This reveals the fold change distribution of the top gene sets with an FDR of under 0.25 by default.
...
```{image} ../../_static/images/data-visualization-portal-gsea-ridge-plot.png
:alt: Ridge Plot
:width: 800px
```
...
- **Network Plot:**
  ...
  - Hovering over one dot will highlight the gene sets it is connected to. The dots can also be moved around by clicking and dragging them.

```{image} ../../_static/images/data-visualization-portal-gsea-network-plot.png
:alt: Network Plot
:width: 800px
```
...
```{image} ../../_static/images/data-visualization-portal-gsea-info.png
:alt: GSEA Info
:width: 800px
```
...
- Filter genes by adjusted P-value or Log2 FC value, the default values are 0.05 and 1, respectively.
- Change the layout of annotations for the Ideogram with the drop down menu, the Histogram annotations layout is shown by default.

```{image} ../../_static/images/data-visualization-portal-ideogram-layout.png
:alt: Ideogram customization options
:width: 200px
```

```{image} ../../_static/images/data-visualization-portal-ideogram.png
...
```{image} ../../_static/images/data-visualization-portal-multi-study.png
...
- Selecting studies for Multi-Study analysis:
  ...
  - Choose multiple different rodent studies containing retina RNAseq data. For this example, OSD-101, OSD-102 and OSD-103 were selected.
  - Mark the checkboxes beside the selected studies in the studies table.
  - Click the "Visualize Study" button to proceed.

```{image} ../../_static/images/data-visualization-portal-multi-study-selection.png
...
```{image} ../../_static/images/data-visualization-portal-multi-study-normalization.png
...
```{image} ../../_static/images/data-visualization-portal-multi-study-combination.png
:alt: Information about study combination
:width: 800px
```

```{image} ../../_static/images/data-visualization-portal-multi-study-normalization-info.png
...
```{image} ../../_static/images/data-visualization-portal-multi-study-pca-plot.png
...
```{image} ../../_static/images/data-visualization-portal-multi-study-3d-pca-plot.png
:alt: 3D PCA Plot
:width: 800px
```
...
```{image} ../../_static/images/data-visualization-portal-multi-study-unnormalized-counts-pca-plot.png
...
- For example, on the image below the user has added material type to the factors table. If the user chooses to use material type as a factor, all samples with material type "Gastrocnemius-left" will be treated as one group, samples with material type "Left kidney" will be treated as a second group and samples with material type "Quadriceps-left" will be treated as a third group. DGE Analysis will then show comparisons (Fold Change, P value, Adjusted P value) between Gastrocnemius-left & Left kidney, Gastrocnemius-left & Quadriceps-left, Left kidney & Quadriceps-left.
...
```{image} ../../_static/images/data-visualization-portal-multi-study-factor-selection.png
:alt: Factor Selection dropdown
:width: 800px
```

- The table will display the values each study contains for the added variables. If a variable is not common between studies and the information is not available on one of the studies' metadata, the table will display an empty value and it will be filled with NA for the next steps.

```{image} ../../_static/images/data-visualization-portal-multi-study-factor-selection-na.png
...
```{image} ../../_static/images/data-visualization-portal-multi-study-delete-factor.png
...
```{image} ../../_static/images/data-visualization-portal-multi-study-dge-sample-selection.png
...
```{image} ../../_static/images/data-visualization-portal-multi-study-dge-sample-selection-search.png
...
```{image} ../../_static/images/data-visualization-portal-multi-study-dge-normalize-with-selection.png
...
- Click "Visualize Studies" to proceed to visualization plots or download the counts table.
...
```{image} ../../_static/images/data-visualization-portal-multi-study-visualize-studies.png
...
```{image} ../../_static/images/data-visualization-portal-multi-study-visualization-results.png
...
```{image} ../../_static/images/data-visualization-portal-multi-study-sidebar.png
:alt: Multi-Study visualization plots
:width: 111px
```
